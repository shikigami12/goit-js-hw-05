/**
 * Extracts the names of users from an array of user objects.
 *
 * @param {Array<Object>} users - An array of user objects where each object contains a `name` property.
 * @returns {Array<string>} An array of names extracted from the given user objects.
 */
